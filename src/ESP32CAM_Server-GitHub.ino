...
const char* host = "Hostname where docker runs";
...
GitESP32CAMServerLibrary::ESP32CAMServerClass ESP32CAMServer(LEDPin, NUMLeds, 185, 16, FLASH_PIN); // Pin, Anzahl LEDs, Brightness, CS, GPIO_FLASH
